...
- **`src/main.ts`** (14810 lines) — THE INFRARED EDITOR: its whole screen, its whole state, and the orchestration between them.
...
- **`src/skyfine.ts`** (503 lines) — The sky selection refined to the picture's own edges.
